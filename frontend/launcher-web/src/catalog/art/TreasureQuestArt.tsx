  ...
  return (
    <svg viewBox="0 0 400 200" className="key-art" role="img" aria-label="Treasure Quest" preserveAspectRatio="xMidYMid slice">
      <defs>
        ...
        <radialGradient id="tq-glow" cx="0.7" cy="0.25" r="0.7">
          <stop offset="0" stopColor="#f0b866" stopOpacity="0.3" />
          <stop offset="1" stopColor="#f0b866" stopOpacity="0" />
        </radialGradient>
        <linearGradient id="tq-chest" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#8a6430" />
          <stop offset="1" stopColor="#5f421c" />
        </linearGradient>
      </defs>
      <rect width="400" height="200" fill="url(#tq-bg)" />
      <rect width="400" height="200" fill="url(#tq-glow)" className="art-pulse" />
      <g>
        <rect x="140" y="96" width="100" height="52" rx="8" fill="url(#tq-chest)" />
