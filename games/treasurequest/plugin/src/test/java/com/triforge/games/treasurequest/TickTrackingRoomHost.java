...
/** Room host stub that tracks monotonic tick for gameplay integration tests. */
final class TickTrackingRoomHost implements RoomHost {

    private final String roomId;
    private long tick;
    private long nextPlayerId = 1L;

    TickTrackingRoomHost(String roomId) {
        this.roomId = roomId;
    }
